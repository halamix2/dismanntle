...
const defaultTitle = 'Steel Trap'
const badgeName = 'badgeAdvanced1'
...
<template>
  ...
  <div class="d-flex flex-column" :style="{ height: '84%' }">
    <MapItem
      ...
      :name="'Coaltown'"
      :missions="['mvm_coaltown_advanced', 'mvm_coaltown_advanced2']"
      :badgeName="badgeName"
    />
    <MapItem
      :thumbnail="thumbnailDecoy"
      :name="'Decoy'"
      :missions="['mvm_decoy_advanced', 'mvm_decoy_advanced2']"
      :badgeName="badgeName"
    />
    <MapItem
      :thumbnail="thumbnailMannworks"
      :name="'Mannworks'"
      :missions="['mvm_mannworks_advanced', 'mvm_mannworks_ironman']"
      :badgeName="badgeName"
    />
  </div>
</template>
